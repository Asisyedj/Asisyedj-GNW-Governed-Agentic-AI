...
/**
 * Performs an HTTPS request only after resolving and pinning every returned
 * address. This closes the DNS-rebinding gap that exists when a hostname is
 * checked first and then passed to a normal fetch implementation.
 */
